# coding=utf-8
STDNUM_FORMATS = {
    # Currently stdnum package supports the following formats:
    'al.nipt': 'NIPT (Numri i Identifikimit për Personin e Tatueshëm, '
               'Albanian VAT number)',
    'ar.cuit': 'CUIT (Código Único de Identificación Tributaria, '
               'Argentinian tax number)',
    ...
    'bg.egn': 'EGN (ЕГН, Единен граждански номер, '
              'Bulgarian personal identity codes)',
    'bg.pnf': 'PNF (ЛНЧ, Личен номер на чужденец, '
              'Bulgarian number of a foreigner)',
    'bg.vat': 'VAT (Идентификационен номер по ДДС, Bulgarian VAT number)',
    'br.cnpj': 'CNPJ (Cadastro Nacional da Pessoa Jurídica, '
               'Brazillian company identifier)',
    'br.cpf': 'CPF (Cadastro de Pessoas Físicas, '
              'Brazillian national identifier)',
    'ch.ssn': 'Swiss social security number ("Sozialversicherungsnummer")',
    'ch.uid': 'UID (Unternehmens-Identifikationsnummer, '
              'Swiss business identifier)',
    'ch.vat': 'VAT, MWST, TVA, IVA, TPV '
    ...
    'co.nit': 'NIT (Número De Identificación Tributaria, '
              'Colombian identity code)',
    ...
    'de.vat': 'Ust ID Nr. (Umsatzsteur Identifikationnummer, '
              'German VAT number)',
    ...
    'do.rnc': 'RNC (Registro Nacional del Contribuyente, '
    ...
    'ec.ruc': 'RUC (Registro Único de Contribuyentes, '
              'Ecuadorian company tax number)',
    'ee.ik': 'Isikukood (Estonian Personcal ID number)',
    'ee.kmkr': 'KMKR (Käibemaksukohuslase, Estonian VAT number)',
    'es.cif': 'CIF (Certificado de Identificación Fiscal, '
              'Spanish company tax number)',
    'es.dni': 'DNI (Documento nacional de identidad, '
              'Spanish personal identity codes)',
    'es.nie': 'NIE (Número de Identificación de Extranjeros, '
              'Spanish foreigner number)',
    ...
    'fr.nif': 'NIF (Numéro d\'Immatriculation Fiscale, '
    ...
    'gr.vat': 'FPA, ΦΠΑ, ΑΦΜ (Αριθμός Φορολογικού Μητρώου, '
              'the Greek VAT number)',
    'grid': 'GRid (Global Release Identifier)',
    'hr.oib': 'OIB (Osobni identifikacijski broj, '
    ...
    'nl.bsn': 'BSN (Burgerservicenummer, '
    ...
    'pl.regon': 'REGON (Rejestr Gospodarki Narodowej, '
    ...
    'ru.inn': 'ИНН (Идентификационный номер налогоплательщика, '
    ...
    'sm.coe': 'COE (Codice operatore economico, '
              'San Marino national tax number)',
