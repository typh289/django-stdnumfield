...
class ValidatorsTests(TestCase):
    def test_invalid_format(self):
        ...
        self.assertRaisesMessage(
            ValueError, 'Unknown stdnum format: "damn"', validator, "123456"
        )
    ...
    def test_valid_format_invalid_value(self):
        validator = StdnumFormatValidator(formats=["hr.oib"])
        self.assertRaises(ValidationError, validator, "69435151531")
    ...
    def test_custom_alphabet(self):
        validator = StdnumFormatValidator(
            formats="iso7064.mod_37_2", alphabets="0123456789X"
        )
        validator("079X")
